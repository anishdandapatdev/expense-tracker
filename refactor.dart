...
void main() async {
  debugPrint('Starting complete project restructuring...');
  ...
  final moveMap = {
    ...
    'lib/src/shared/currency_service.dart':
    ...
    'lib/src/features/expenses/domain/account_model.dart':
        'lib/models/account_model.dart',
    'lib/src/features/expenses/domain/category_model.dart':
        'lib/models/category_model.dart',
    'lib/src/features/expenses/domain/expense_model.dart':
        'lib/models/expense_model.dart',

    'lib/src/features/authentication/data/auth_repository.dart':
        'lib/repositories/auth_repository.dart',
    'lib/src/features/expenses/data/account_repository.dart':
        'lib/repositories/account_repository.dart',
    'lib/src/features/expenses/data/category_repository.dart':
    ...
    'lib/src/features/authentication/presentation/onboarding_screen.dart':
        'lib/features/auth/onboarding_screen.dart',

    'lib/src/features/expenses/presentation/dashboard_screen.dart':
        'lib/features/dashboard/dashboard_screen.dart',

    'lib/src/features/expenses/presentation/add_expense_screen.dart':
        'lib/features/expenses/add_expense_screen.dart',
    'lib/src/features/expenses/presentation/category_management_screen.dart':
        'lib/features/expenses/category_management_screen.dart',
    'lib/src/features/expenses/presentation/account_management_screen.dart':
        'lib/features/expenses/account_management_screen.dart',

    'lib/src/features/analytics/analytics_screen.dart':
        'lib/features/reports/analytics_screen.dart',
    'lib/src/features/settings/settings_screen.dart':
        'lib/features/settings/settings_screen.dart',
    'lib/src/features/main/main_screen.dart':
  ...
  for (var entry in moveMap.entries) {
    ...
    final packagePath = newPath.replaceFirst(
      'lib/',
    ...
    for (var entity in dir.listSync(recursive: true)) {
      if (entity is File && entity.path.endsWith('.dart')) {
        ...
        content = content.replaceAllMapped(importRegex, (match) {
          ...
          if (importString == 'firebase_options.dart') {
  return "import 'package:expense_tracker/firebase_options.dart';";
}
  ...
  debugPrint('Fixing imports across lib/ and test/ ...');
  ...
  if (srcDir.existsSync()) {
    try {
      ...
      debugPrint('Deleted lib/src successfully.');
    } catch (_) {}
  }

  debugPrint('Refactoring Complete!');
}
